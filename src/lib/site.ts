...
export const projects: Project[] = [
  {
    ...
    href: "/work/sono",
    image: null,
    imageAlt: "Sono producer storefront with license tiers and in-page checkout.",
  },
  {
    index: "02",
    slug: "matchday",
    ...
    image: null,
    imageAlt:
      "Matchday formation builder in dark mode with position colours across the squad list and pitch view.",
  },
  {
    index: "03",
    slug: "stash",
    ...
    href: "/work/stash",
    image: null,
    imageAlt: "Stash savings goal and group pool screens in the deep indigo base palette.",
  },
];
